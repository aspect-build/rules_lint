...
def _ruff_repo_impl(rctx):
    rctx.file("BUILD", """# Generated by shellcheck.bzl
alias(
    name = "{0}", 
    actual = select({{
        "@bazel_tools//src/conditions:linux_x86_64": "@{0}_x86_64-unknown-linux-gnu//:ruff",
        "@bazel_tools//src/conditions:linux_aarch64": "@{0}_aarch64-unknown-linux-gnu//:ruff",
        "@bazel_tools//src/conditions:darwin_arm64": "@{0}_aarch64-apple-darwin//:ruff",
        "@bazel_tools//src/conditions:darwin_x86_64": "@{0}_x86_64-apple-darwin//:ruff",
    }),
    visibility = ["//visibility:public"],
)""".format(rctx.name))

ruff_repo = repository_rule(_ruff_repo_impl)
