...
def cppcheck_action(ctx, compilation_context, executable, srcs, stdout, exit_code, do_xml = False, args = []):
    ...
    Args:
        ...
        args: additional command-line arguments passed to cppcheck
    """
