...
def _clippy_aspect_impl(target, ctx):
    ...
    clippy_flags = [
        ...
        "-Wwarnings",
    ] + ctx.attr._clippy_flags + ctx.attr._extra_args
...
def lint_clippy_aspect(config, rule_kinds = DEFAULT_RULE_KINDS, clippy_flags = [], extra_args = []):
    ...
    Args:
        ...
        extra_args (List[str]): Additional options to pass to Clippy.
