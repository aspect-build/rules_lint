...
if [ $machine == "Windows" ]; then
	...
	args=("--aspects=$(echo //tools/lint:linters.bzl%{flake8,pmd,ruff,vale,clang_tidy,clippy} | tr ' ' ',')")
else
	args=("--aspects=$(echo //tools/lint:linters.bzl%{buf,eslint,flake8,keep_sorted,ktlint,pmd,ruff,shellcheck,stylelint,vale,clang_tidy,spotbugs,clippy} | tr ' ' ',')")
fi
