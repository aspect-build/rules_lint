...
if [ $machine == "Windows" ]; then
	...
	args=("--aspects=$(echo //tools/lint:linters.bzl%{flake8,pmd,ruff,vale,yamllint,clang_tidy} | tr ' ' ',')")
else
	args=("--aspects=$(echo //tools/lint:linters.bzl%{buf,eslint,flake8,keep_sorted,ktlint,pmd,ruff,shellcheck,stylelint,vale,yamllint,clang_tidy,spotbugs} | tr ' ' ',')")
fi
